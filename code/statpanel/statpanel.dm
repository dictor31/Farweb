...
/client/proc/optionsUpdate()
	return "<tr><td>" + generateVerbList(list(list("OOC", "OOC"), list("Adminhelp", "Admin Help"), list(".togglefullscreen", "Toggle Fullscreen"), list("LobbyMusic", "Toggle Lobby Music"), list("Midis", "Toggle Midis"), list("AmbiVolume", "Ambience Volume (0-255)"), list("MusicVolume", "Music Volume (0, 255)"))) + "</td></tr>"
...
#else
	src << browse('code/chatpanel/browserassets/html_live/chatpanel.html', "window=browseroutput")
	src << browse('code/statpanel/html/html_live/statpanel.html', "window=outputwindow.browser; size=411x330;")
#endif
